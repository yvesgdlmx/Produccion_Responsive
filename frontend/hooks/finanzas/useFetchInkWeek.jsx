...
export const useFetchInkWeek = (anio, semana) => {
        ...
        const grouped = registros.reduce((acc, registro) => {
          ...
          if (!acc[fecha]) {
            acc[fecha] = {
              ...
              fecha,
              ink_trabajosTallados: registro.TotTrabajos ? Number(registro.TotTrabajos) : 1,
            ...
            acc[fecha].ink_trabajosTallados += registro.TotTrabajos ? Number(registro.TotTrabajos) : 1;
