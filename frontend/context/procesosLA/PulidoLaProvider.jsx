...
const PulidoLaContext = createContext();
const PulidoLaProvider = ({ children }) => {
  // Estados generales
  ...
  // Funciones para guardar y editar notas de turno
  ...
  // Función para alternar la visualización del recuadro de notas
  ...
  // useEffect para obtener datos (metas, registros y notas)
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (ahora.hour() >= 22) {
          // Jornada nocturna: de hoy 22:00 a mañana 06:00; luego los turnos del día siguiente
        ...
        // 6. Calcular la meta acumulada en vivo según el turno actual
        let metaAcumulada = 0;
        ...
        // 7. Determinar el último registro para calcular el corte de la siguiente media hora
...
export { PulidoLaProvider };
export default PulidoLaContext;