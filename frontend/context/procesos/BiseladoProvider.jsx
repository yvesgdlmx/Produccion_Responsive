...
const BiseladoContext = createContext();
const BiseladoProvider = ({ children }) => {
  // Estados generales
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // 1. Se obtiene el registro global de metas desde el endpoint '/metas/metas-biselados'
        ...
        // 2. Se obtienen los registros actuales de hoy
  ...
  // useEffect para cargar las notas de turno de la sección "biselado"
  useEffect(() => {
  ...
  return (
    <BiseladoContext.Provider value={{
      totalHits,
      ultimaHora,
      siguienteHora,
      meta,
      ...
      {children}
    </BiseladoContext.Provider>
  );
};
export { BiseladoProvider };
export default BiseladoContext;