                ...
                <div className='flex flex-col md:flex-row justify-around mt-4 font-semibold mb-4'>
                    <div className="bg-white p-2 px-10 rounded-lg shadow-md">
                        <p className="text-gray-600 text-sm md:text-base">
                            ...
                            <span className="text-gray-600 font-semibold block">/ Meta: {formatNumber(metasPorTurno.nocturno)}</span>
                        </p>
                    </div>
                    <div className="bg-white p-2 px-10 rounded-lg mb-2 md:mb-0 shadow-md">
                        <p className="text-gray-600 text-sm md:text-base">
                            ...
                            <span className="text-gray-600 font-semibold block">/ Meta: {formatNumber(metasPorTurno.matutino)}</span>
                        </p>
                    </div>
                    <div className="bg-white p-2 px-10 rounded-lg mb-2 md:mb-0 shadow-md">
                        <p className="text-gray-600 text-sm md:text-base">
                            ...
                            <span className="text-gray-600 font-semibold block">/ Meta: {formatNumber(metasPorTurno.vespertino)}</span>
                        </p>
                    </div>
                </div>
            </div>
