...
// La misma versión actualizada de getTurnWithTime
              ...
              >
                {columns.map((col) => {
                  if (col.accessor.startsWith("hour_")) {
                    ...
                    const valorColor = valor >= meta ? "text-green-700" : "text-red-700";
                    return (
            ...
            <tr className="bg-blue-50 font-semibold">
              {columns.map((col) => {
                if (col.accessor === "totalAcumulado") {
                  ...
                  const valorColor = valor >= metaTotal ? "text-green-700" : "text-red-700";
                  return (
                    <td key={col.accessor} className="px-6 py-4 text-sm border-b border-gray-200">
                      <div className="font-bold">hits / meta</div>
                      <div>
