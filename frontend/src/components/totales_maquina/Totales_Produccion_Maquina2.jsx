...
const Totales_Produccion_Maquina2 = () => {
    ...
    const fetchMetas = async () => {
      try {
        ...
        registrosFiltrados.forEach((reg) => {
          // Al extraer el nombre base, se obtiene "32 JOB COMPLETE"
  ...
  return (
    <div className="p-4">
      <Heading title="Resumen de producción manual (32 JOB COMPLETE)" />
      <AreaSelect />
      <TablaSurtidoMaquina
        columns={allColumns}
...
export default Totales_Produccion_Maquina2;