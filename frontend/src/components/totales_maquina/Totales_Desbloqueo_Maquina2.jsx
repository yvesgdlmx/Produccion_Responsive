...
const Totales_Desbloqueo_Maquina2 = () => {
  ...
  useEffect(() => {
    const fetchMetas = async () => {
      try {
        ...
        // Filtrar para registros cuyo nombre comienza con "320 DEBLOCKING"
        ...
        registrosFiltrados.forEach((reg) => {
          // Al extraer el nombre base, se obtiene "320 DEBLOCKING"
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Filtrar por registros cuyo name comience con "320 DEBLOCKING"
...
export default Totales_Desbloqueo_Maquina2;