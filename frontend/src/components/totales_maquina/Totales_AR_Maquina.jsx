  ...
  useEffect(() => {
    const cargarDatos = async () => {
      try {
        ...
        const metasAR = responseMetas.data.registros.filter(meta => 
          ['91', '92', '52', '53', '54', '55', '56'].some(num => meta.name.includes(num))
        );
        const sumaMetas = metasAR.reduce((acc, meta) => acc + meta.meta, 0);
        setMeta(sumaMetas);
        ...
        <table className="min-w-full bg-white border">
          ...
          <tbody className="text-center">
            <tr className="font-semibold text-gray-700">
              <td className="py-2 px-4 border-b font-bold" style={{ minWidth: '250px' }}>AR</td>
