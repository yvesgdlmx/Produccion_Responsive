...
const Surtido_procesos = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // 1. Obtener las metas y filtrar solo las que tienen "LENS LOG"
        ...
        // Sumar las metas para cada turno
        const sumaMetaNocturno = metasLensLog.reduce((acc, curr) => acc + curr.meta_nocturno, 0);
        const sumaMetaMatutino = metasLensLog.reduce((acc, curr) => acc + curr.meta_matutino, 0);
        const sumaMetaVespertino = metasLensLog.reduce((acc, curr) => acc + curr.meta_vespertino, 0);
        // 2. Obtener los registros y filtrar solo los que tienen "LENS LOG"
        ...
        //    - En el turno nocturno se utiliza el tiempo transcurrido desde el inicio.
        //    - En el turno matutino se suma la meta completa del nocturno y la parte transcurrida del matutino.
        //    - En el turno vespertino se acumulan los dos turnos completos y la parte del vespertino.
        let metaAcumulada = 0;
