...
const ReporteWipOperacionResumenNvi = () => {
  ...
  const columnasPrincipales = [
    ...
    },
    {
      ...
      label: "Tallado",
      detalles: [
        { key: "auditoria_tallado", label: "AuditorÃ­a" },
    ...
    },
    {
      ...
      label: "Terminado",
      detalles: [
        { key: "auditoria_terminado", label: "AuditorÃ­a" },
        { key: "biselado_automatico", label: "Biselado AutomÃ¡tico" },
        { key: "biselado_manual", label: "Biselado Manual" },
        { key: "inspeccion", label: "InspecciÃ³n" },
    ...
    const obtenerDatos = async () => {
      ...
      try {
        const response = await clienteAxios.get(
          `/reportes/wip_operacion_resumen_nvi/resumen/${anio}/${mes}/${dia}`
        );
  ...
  return (
    <>
      <div className="mt-4 md:mt-0">
        <Heading title="Reporte WIP Operacion Resumen NVI" />
      </div>
        ...
        <div className="px-3 py-4 sm:px-6 sm:py-6 lg:px-8">
          ...
          {datosAPI.length === 0 ? (
            <div className="mx-auto mt-8 text-center text-xl font-semibold text-red-600">
              No hay registros NVI disponibles para la fecha {fechaCapitalizada}
            </div>
          ) : (
                    ...
                    <div className="flex flex-col gap-4 sm:gap-6">
                      <div className="flex flex-col gap-4 border-b border-gray-100 pb-4 sm:flex-row sm:items-center sm:justify-between">
                        <h3 className="text-xl font-bold leading-snug text-gray-500 sm:text-2xl">
                          WIP Operacion Resumen NVI - {formatearHora(bloque.hora)}
                        </h3>
...
export default ReporteWipOperacionResumenNvi;
