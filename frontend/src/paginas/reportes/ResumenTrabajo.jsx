                ...
                <div className="p-6">
                  <div className="flex flex-col space-y-6">
                    <div className="flex justify-between items-center border-b border-gray-100 pb-4">
                      <h3 className="text-2xl font-bold text-gray-500">Resumen General - {formatearHora(bloque.hora)}</h3>
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                          ...
                          <tbody className="bg-white divide-y divide-gray-200">
                            {bloque.datos.map((fila, index) => (
                              <tr key={`${fila.fecha}-${index}`} className={`text-center transition-colors duration-150 hover:bg-gray-50 ${index % 2 === 0 ? 'bg-gray-50' : ''}`}>
